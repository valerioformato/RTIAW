...
tl::optional<HitRecord> Plane::Hit(const Ray &r, const float t_min, const float t_max) const {
...
tl::optional<Shapes::AABB> Plane::BoundingBox(float time0, float time1) const {
  return Shapes::AABB{
